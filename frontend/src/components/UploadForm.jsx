...
/* ---- Constantes + validador fuera del componente (estables) ---- */
...
const validarArchivo = (file) => {
  ...
  if (MIME_OK.includes(file.type)) return true; // fallback por MIME
  return false;
};
...
export default function UploadForm() {
  ...
  /* ---- onPaste memorizado y usado como dependencia del effect ---- */
  ...
  return (
    ...
    >
      <div className="row h-100 g-0 m-0">
        ...
        {/* Columna derecha: imagen full-cover */}
